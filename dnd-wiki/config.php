...
##  $PubDirUrl is the URL for the pub directory.
 $ScriptUrl = 'http://www.leakypixel.net/dnd-wiki/pmwiki.php';
 $PubDirUrl = 'http://www.leakypixel.net/dnd-wiki/pub';

## Use "Clean URLs".
$EnablePathInfo = 1;
$ScriptUrl = "http://www.leakypixel.net/dnd-wiki";
...
$PageLogoUrl = "$ScriptUrl/logo.jpg";
...
# $DefaultPasswords['admin'] = crypt('thisismyrifle');
